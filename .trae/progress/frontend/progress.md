...
- [ ] frontend_009: 实现小说编辑页面 ← 当前任务

### 阶段3: 角色管理界面
- [ ] frontend_010: 实现角色列表页面
- [ ] frontend_011: 实现角色详情页面
- [ ] frontend_012: 实现角色创建页面
- [ ] frontend_013: 实现角色编辑页面

### 阶段4: 章节生成界面
- [ ] frontend_014: 实现章节列表页面
- [ ] frontend_015: 实现章节生成页面
- [ ] frontend_016: 实现章节编辑页面
- [ ] frontend_017: 实现实时预览功能
