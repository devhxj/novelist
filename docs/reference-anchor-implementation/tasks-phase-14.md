...
- [ ] Bridge/agent authority tests proving no bypass of user approvals. Material/profile visibility, draft-audit inspection, and dedicated style-audit inspection authority are covered at MAF executor/integration level; the remaining approval matrix remains open.
