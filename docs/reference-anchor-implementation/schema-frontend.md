...
- bulk import multiple local `.txt`/`.md` source paths through `CreateReferenceAnchors`, reusing the current corpus metadata fields and deriving per-source titles when needed
