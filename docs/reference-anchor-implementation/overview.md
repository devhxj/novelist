...
- `SqliteReferenceAnchorService` has a dedicated SQLite database, source import, deterministic segmentation, material extraction, first-class material slot storage, material search, strict declared-slot L1 adaptation, and reuse audit scaffolding;
