...
Phases 0-11 and Phase 13 are complete in the task tracker. Remaining work is tracked explicitly in [tasks phases 10-12](tasks-phases-10-12.md): Phase 12 covers the shared reference corpus and AI-driven material selection model across novels.

This plan remains the source of truth for the target design. Treat Phase 12 as the only open implementation-plan phase unless contracts, storage, bridge, agent, or frontend behavior regresses.
