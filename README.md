...
- **素材库**：左侧管理参考书籍，可筛选、选择本地文件、添加、删除和勾选可用来源；中间展示 ready 来源的六维语料覆盖并按需检索材料；右侧可用所选书籍进行临时蓝图预演，比较候选策略、节拍和来源分布。预演不创建章节 session、不生成正文候选，也不写入编辑器；章节蓝图和正文插入仍只在章节参考素材面板完成。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>M1 产品薄切片成立；M2 的 50K 全管线标准门已通过；M3-M5 等待真实效果证据；M6-M8 冻结扩张；M9 的章节默认路径自动化已收口，素材库工作台仍待专用浏览器验收和真实用户任务验证。整体仍为 S，尚未达到生产闭环 P 或规模化 L。</td>
    </tr>
    <tr>
...
- `素材库`添加参考书现在会快速登记来源，确认章节边界后由单 worker 逐章完成材料提取、embedding 和向量索引；一章完整提交后才推进下一章。
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>运行素材库参考书籍管理和临时蓝图预演的聚焦浏览器工作流。</td>
    </tr>
    <tr>
