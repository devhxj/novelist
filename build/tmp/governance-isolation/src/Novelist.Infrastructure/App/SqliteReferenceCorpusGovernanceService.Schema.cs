...
public sealed partial class SqliteReferenceCorpusGovernanceService
{
 ...
 "CREATE TABLE IF NOT EXISTS reference_style_profiles (aggregate_id TEXT PRIMARY KEY, summary TEXT NOT NULL, sample_count INTEGER NOT NULL, validity_state TEXT NOT NULL, updated_at TEXT NOT NULL);",
 "CREATE TABLE IF NOT EXISTS reference_scene_templates (aggregate_id TEXT PRIMARY KEY, summary TEXT NOT NULL, sample_count INTEGER NOT NULL, validity_state TEXT NOT NULL, updated_at TEXT NOT NULL);",
 "CREATE TABLE IF NOT EXISTS reference_world_models (aggregate_id TEXT PRIMARY KEY, summary TEXT NOT NULL, sample_count INTEGER NOT NULL, validity_state TEXT NOT NULL, updated_at TEXT NOT NULL);",
 "CREATE TABLE IF NOT EXISTS reference_dialogue_techniques (aggregate_id TEXT PRIMARY KEY, summary TEXT NOT NULL, sample_count INTEGER NOT NULL, validity_state TEXT NOT NULL, updated_at TEXT NOT NULL);",
