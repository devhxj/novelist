...
export function parseRunConfig(args) {
  ...
  if (config.grep && !['@startup', '@diagnostics', '@surface', '@phase15-surface', '@phase15-stress', '@phase15-compact', '@writing', '@reference-anchor', '@pattern', '@git', '@update', '@time', '@layout', '@error'].includes(config.grep)) {
